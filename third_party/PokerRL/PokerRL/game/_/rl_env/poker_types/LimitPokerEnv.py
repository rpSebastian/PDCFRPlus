...
class LimitPokerEnv(_PokerEnv):
    ...
    def __init__(self, env_args, is_evaluating, lut_holder):
    ...
    def _adjust_raise(self, raise_total_amount_in_chips):
        b = (
            self.BIG_BET
            if self.current_round >= self.ROUND_WHERE_BIG_BET_STARTS
            else self.SMALL_BET
        )
    ...
    def get_legal_actions(self):
        ...
        if (
            self.n_raises_this_round < self.MAX_N_RAISES_PER_ROUND[self.current_round]
